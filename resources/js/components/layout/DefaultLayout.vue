<template>
  <div class="h-screen w-full flex flex-col lg:flex-row bg-gray-50 dark:bg-zinc-900">
    <!-- Mobile top bar -->
    <header class="lg:hidden flex items-center justify-between bg-white dark:bg-zinc-900 px-4 py-3 shadow-sm ring-1 ring-zinc-200/60 dark:ring-zinc-800 z-40 shrink-0">
