<template>
  <div class="h-screen min-h-[100dvh] flex flex-col lg:flex-row bg-gray-50 dark:bg-zinc-900 overflow-hidden">
    <!-- Mobile top bar -->
    <header class="lg:hidden flex items-center justify-between bg-white dark:bg-zinc-900 px-4 py-3 shadow-sm ring-1 ring-zinc-200/60 dark:ring-zinc-800 z-50">
